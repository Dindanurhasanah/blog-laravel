            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="nickname" class="col-md-4 col-form-label text-md-end">{{ __('Gender') }}</label>
                            ...
                            <div class="col-md-7">
                                <div class="form-check form-check-inline icheck-primary d-inline">
                                    ...
                                    <label class="form-check-label" form="statusRadio1">Male</label>
                                </div>
                            <div class="col-md-7">
                                <div class="form-check form-check-inline icheck-primary d-inline">
                                    <input class="form-check-input" type="radio" name="gender" id="statusRadio2" value="1">
                                    <label class="form-check-label" form="statusRadio2">Female</label>
                                </div>
                            </div>
                            </div>
                        </div>
