                        ...
                        <div class="page-wrapper">
                            <div class="blog-title-area text-center">
                                <ol class="breadcrumb hidden-xs-down">
                                    ...
                                    <li class="breadcrumb-item active">{{ isset($post) ? $post->title : '' }}</li>
                                </ol>

                                <span class="color-orange"><a href="category/{{ $post->category->slug }}" title="">{{ $post->category->name }}</a></span>

                                <h3>{{ isset($post) ? $post->title : '' }}</h3>

                                <div class="blog-meta big-meta">
                                    <small><a href="tech-single.html" title="">{{ isset($post) ? $post->updated_at : '' }}</a></small>
                            ...
                            <div class="blog-content">  
                                <div class="pp">
                                    <h3><strong>{{ isset($post) ? $post->description : '' }}</strong></h3>
                                            ...
                                            <div class="list-group">
                                                <a href="tech-single.html" class="list-group-item list-group-item-action flex-column align-items-start">
                                                    <div class="w-100 justify-content-between text-right">
                                                        <img src="upload/LogoDinda.jpg" alt="" class="img-fluid float-right">
                            ...
                            <div class="custombox authorbox clearfix">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                        ...
                                        <p>Seorang mahasiswa yang suka berbagi informasi lewat tulisan. Terimakasih telah mengunjungi <a href="#">SIBOLA</a> </p>
